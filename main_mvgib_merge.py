...
beta_range = np.geomspace(1,8192,num=1024) # collect: beta, izx, izy, niter, conv
...
for bidx, beta in enumerate(beta_range):
	...
	out_dict = alg.GaussianBA(cov_x12,cov_y,cov_x12y,beta,maxiter,conv_thres)
...
with open("result_merge_ba.npy","wb") as fid:
